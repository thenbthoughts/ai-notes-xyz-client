    ...
    return (
        <div>
            <div key={comment._id} className="">
                <div className="bg-zinc-950 rounded-sm p-2">
                    <div>
                        ...
                        {comment.fileType && comment.fileUrl && (
                            <div className="bg-zinc-950 rounded-sm py-2">
                        ...
                        <div>
                            <span className="text-s text-zinc-400 mr-2">
        ...
        <div className="gap-2 mt-2">
            <div className="mt-1">
                <textarea
                    ...
                    className="w-full p-2 border border-zinc-700 bg-zinc-900 text-zinc-100 rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    rows={5}
