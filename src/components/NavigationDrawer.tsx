...
const navLinkClass =
    'block rounded-md px-2 py-1.5 text-xs font-medium text-zinc-200 transition hover:bg-zinc-800 hover:text-teal-400';
...
const NavigationDrawer = () => {
    ...
    return (
        <div
            className={`fixed left-0 top-0 h-full w-[min(280px,92vw)] border-r border-zinc-700 bg-zinc-900 shadow-lg transition-transform duration-300 ease-out ${
        ...
        >
            <button
                ...
                className="absolute right-2 top-[68px] rounded-md p-1 text-zinc-400 transition hover:bg-zinc-800 hover:text-zinc-200"
                    ...
                    <ul className="space-y-0.5">
                        ...
                        {authState.isLoggedIn === 'true' && (
                            <li>
                                <Link
                                    to="/logout"
                                    className={`${navLinkClass} font-semibold text-rose-400 hover:bg-rose-950 hover:text-rose-300`}
                                    onClick={handleLinkClick}
                                >
                                    Logout
                                </Link>
