...
const TextToSpeechModal = () => {
    ...
    return (
        ...
        >
            <div className="container mx-auto bg-zinc-900 rounded-sm p-4" style={{ maxWidth: '600px' }}>
                <div className="flex justify-between items-center mb-4">
                    <h1 className="text-2xl font-bold text-zinc-100">Text To Speech</h1>
                    <button
                ...
                <div className="max-h-96 overflow-y-auto">
                    <div className="mb-4 p-3 bg-zinc-950 rounded-sm">
                        <div style={{ overflowY: 'auto', maxHeight: '200px' }}>
                            <p className="text-zinc-100 whitespace-pre-wrap">{ttsModalOpenStatus.text}</p>
                        </div>
                    </div>
                </div>
            </div>
