...
const ComponentMemorySettings = () => {
    ...
    if (isLoading) {
        return (
            <div className="bg-zinc-900 rounded-sm p-6 border border-zinc-700 shadow-sm">
                <div className="text-center py-4">
                    <div className="text-zinc-400">Loading memory settings...</div>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="bg-zinc-900 rounded-sm p-6 border border-zinc-700 shadow-sm mb-6">
            <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-xl font-bold text-zinc-200">Memory Settings</h2>
            </div>
                ...
                <div>
                    ...
                    <div className="flex items-center">
                        <input
                            ...
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-zinc-700 rounded"
                        />
                        <span className="ml-2 text-sm text-zinc-300">Enable memory storage and usage in conversations</span>
                    </div>
                ...
                {isStoreUserMemoriesEnabled && (
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 border border-zinc-700 rounded-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                            placeholder="15"
                        />
                        <p className="mt-2 text-sm text-zinc-400">
