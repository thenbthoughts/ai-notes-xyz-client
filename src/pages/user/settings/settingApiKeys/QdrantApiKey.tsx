...
const QdrantApiKey = () => {
    ...
    return (
        <div className="mb-4">
            <div>
                <label htmlFor="apiKeyOllama" className="block text-zinc-300 font-bold mb-2">
                    Qdrant Api Key
            ...
            <div>
                <label htmlFor="apiKeyQdrantEndpoint" className="block text-zinc-300 font-bold mb-2">
                    Qdrant Endpoint
                </label>
                <input
                    type="text"
            ...
            <div>
                <label htmlFor="apiKeyQdrantPassword" className="block text-zinc-300 font-bold mb-2">
                    Qdrant Password
                </label>
                <input
                    type="text"
