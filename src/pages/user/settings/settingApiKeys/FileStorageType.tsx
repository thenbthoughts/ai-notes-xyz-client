...
const FileStorageType = () => {
    ...
    return (
        <div className="mb-4">
            <label htmlFor="fileStorageType" className="block text-zinc-300 font-bold mb-2">
                File Storage Type
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <button
                    ...
                    className={`border-2 rounded-lg p-4 cursor-pointer transition-all duration-200 text-left relative ${
                        authState.fileStorageType === "gridfs"
                            ...
                            : "border-zinc-700 bg-zinc-900 hover:border-blue-300"
                    }`}
                >
                    {authState.fileStorageType === "gridfs" && (
                    ...
                    <div className="mb-2">
                        <span className="font-semibold text-zinc-200">GridFS (MongoDB)</span>
                    </div>
                ...
                <button
                    ...
                    className={`border-2 rounded-lg p-4 transition-all duration-200 text-left relative ${
                        !authState.apiKeyS3Valid
                            ...
                            : "border-zinc-700 bg-zinc-900 hover:border-purple-300 cursor-pointer"
                    }`}
                ...
                >
                    ...
                    <div className="mb-2">
                        <span className={`font-semibold ${!authState.apiKeyS3Valid ? 'text-zinc-400' : 'text-zinc-200'}`}>
                            S3 Compatible
                        </span>
                    </div>
                    <p className="text-sm text-zinc-400">
