...
const SmtpSettings = () => {
    ...
    return (
        <div className="mb-4">
            <div>
                <label htmlFor="smtpHost" className="block text-zinc-300 font-bold mb-2">
                    SMTP Host
                    {authState.smtpValid ? (
            ...
            <div>
                <label htmlFor="smtpPort" className="block text-zinc-300 font-bold mb-2">
                    SMTP Port
                </label>
                <input
                    type="number"
            ...
            <div>
                <label htmlFor="smtpUser" className="block text-zinc-300 font-bold mb-2">
                    SMTP User
                </label>
                <input
                    type="text"
            ...
            <div>
                <label htmlFor="smtpPassword" className="block text-zinc-300 font-bold mb-2">
                    SMTP Password
                </label>
                <input
                    type="password"
            ...
            <div>
                <label htmlFor="smtpFrom" className="block text-zinc-300 font-bold mb-2">
                    SMTP From
                </label>
                <input
                    type="email"
            ...
            <div>
                <label htmlFor="smtpTo" className="block text-zinc-300 font-bold mb-2">
                    SMTP To
                </label>
                <input
                    type="email"
