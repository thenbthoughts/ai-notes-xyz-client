...
const TelegramTokenSave = ({
    ...
    return (
        <div className="mb-4">
            <div className="mb-4 rounded-sm border border-zinc-700 bg-zinc-950/90 p-3 text-sm text-zinc-300">
                <p className="font-semibold text-zinc-200 mb-2">Steps</p>
                <ol className="list-decimal list-inside space-y-1.5 leading-relaxed">
                    <li>
                        ...
                        , run <code className="rounded bg-zinc-900 px-1 text-xs border border-zinc-700">/newbot</code>, and copy the <strong>bot token</strong>.
                    </li>
                    <li>
            ...
            <div>
                <label htmlFor="telegramBotToken" className="block text-zinc-300 font-bold mb-2">
                    Bot token
                    {authState.telegramValid ? (
                        ...
                        <span className="inline-block bg-amber-950 text-amber-200 py-1 px-3 rounded-sm text-sm font-semibold ml-3">
