    ...
    const renderApiKeys = () => {
        return (
            <div
                id="api-keys"
            >
                <h2 className="text-xl font-bold text-zinc-100 py-2">Api Keys</h2>
                ...
                {/* Selection Buttons */}
                <div className="mb-6">
                    <h3 className="text-lg font-semibold text-zinc-200 mb-3">Select Option to Configure</h3>
                    <div className="flex flex-wrap gap-2">
                        {selectionOptions.map((option) => {
                            ...
                            if (option.type === 'api') {
                                ...
                                } else if (option.key === 'agentWorkspace') {
                                ...
                                <button
                                    ...
                                    className={`px-3 py-2 rounded-lg border-2 transition-all duration-200 text-center min-w-0 flex-shrink-0 flex items-center gap-2 ${
                                        selectedOption === option.key
                                            ...
                                            : 'border-zinc-700 bg-zinc-900 hover:border-zinc-700 text-zinc-300'
                                    }`}
                                >
                ...
                <div className="mt-6">
                    ...
                    {selectedOption === null && (
                        <div className="text-center py-8 text-zinc-400 bg-zinc-950 rounded-lg border-2 border-dashed border-zinc-700 my-6">
                            ...
                            <p className="text-zinc-400 font-medium">Select an option from above to configure it</p>
                        </div>
                    )}
                </div>
            </div>
