...
const TelegramConversationList = ({
    ...
    return (
        <div className="mb-4 rounded-sm border border-zinc-700 bg-zinc-900 p-3 shadow-sm">
            <h3 className="text-base font-semibold text-zinc-200 mb-2">Conversations &amp; delivery</h3>
            ...
            {chatOptions.length >= 1 && !showManualChatId && (
                <div className="mt-3">
                    <label htmlFor="telegramChatSelect" className="block text-zinc-300 font-bold mb-2">
                        Send notifications to
                    </label>
                    <select
                        id="telegramChatSelect"
                        className="shadow border border-zinc-700 rounded-sm w-full py-2 px-3 bg-zinc-800 text-zinc-200 focus:outline-none focus:shadow-outline"
            ...
            {showManualChatId && (
                <div className="mt-2 space-y-2">
                    <div>
                        <label htmlFor="telegramChatIdManual" className="block text-zinc-300 font-bold mb-2">
                            Chat ID
                        </label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label htmlFor="telegramTopicIdManual" className="block text-zinc-300 font-bold mb-2">
