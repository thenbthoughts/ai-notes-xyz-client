...
const LocalaiApiKey = () => {
    ...
    return (
        <div className="mb-4">
            <div>
                <label htmlFor="apiKeyLocalai" className="block text-zinc-300 font-bold mb-2">
            ...
            <div>
                <label htmlFor="apiKeyLocalaiEndpoint" className="block text-zinc-300 font-bold mb-2">
                    LocalAI Endpoint
                </label>
                <input
                    type="text"
