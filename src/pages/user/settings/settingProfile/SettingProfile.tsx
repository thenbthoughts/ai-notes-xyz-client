...
const InputEmailVerify = ({
    ...
    return (
        <Fragment>
            {/* send otp */}
            <div>
                <label htmlFor="email" className="block text-zinc-300 font-bold mb-2">
                    Email
            ...
            {showOtp && (
                <div>
                    <label htmlFor="otp" className="block text-zinc-300 font-bold mb-2">
                        OTP
                    </label>
                    <input
                        type="number"
...
const Setting = () => {
    ...
    const snapshot = useMemo(() => {
        return JSON.stringify({ name, dateOfBirth, profilePictureLink, bio, languages, city, state, zipCode, country });
    }, [name, dateOfBirth, profilePictureLink, bio, languages, city, state, zipCode, country]);
    ...
    const fetchUser = async () => {
        try {
            ...
            setUsername(response.data.username || response.data.userId || response.data._id || '');
            ...
            const snap = JSON.stringify({ name: response.data.name || "", dateOfBirth: response.data.dateOfBirth || "", profilePictureLink: response.data.profilePictureLink || "", bio: response.data.bio || "", languages: response.data?.languages || [], city: response.data.city || "", state: response.data.state || "", zipCode: response.data.zipCode || "", country: response.data.country || "" });
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        setSuccessMessage("");
        try {
            const response = await axiosCustom.post(`/api/user/crud/updateUser`, { name, email, dateOfBirth, profilePictureLink, bio, languages, city, state, zipCode, country }, { headers: { 'Content-Type': 'application/json' }, withCredentials: true });
    ...
    const renderPersonalInfo = () => {
        return (
            <div>
                <div className="mb-4">
                    <label htmlFor="username" className="block text-zinc-300 font-bold mb-2">
                        Username
                    </label>
                    <input
                        type="text"
                ...
                <div className="mb-4">
                    <label htmlFor="name" className="block text-zinc-300 font-bold mb-2">
                        Name
                    </label>
                    <input
                        type="text"
                ...
                <div className="mb-4">
                    <label htmlFor="dateOfBirth" className="block text-zinc-300 font-bold mb-2">
                        Date of Birth
                    </label>
                    <input
                        type="date"
                ...
                <div className="mb-4">
                    <label htmlFor="languages" className="block text-zinc-300 font-bold mb-2">
                        Languages
                    </label>
                    <Select
                ...
                <div className="mb-4">
                    <label htmlFor="bio" className="block text-zinc-300 font-bold mb-2">
                        Bio
                    </label>
                    <textarea
                        id="bio"
    ...
    const renderLocation = () => {
        return (
            <div>
                <h2 className="text-xl font-bold text-zinc-100 py-2">Location</h2>
                <div className="mb-4">
                    <label htmlFor="city" className="block text-zinc-300 font-bold mb-2">
                        City
                    </label>
                    <input
                        type="text"
                ...
                <div className="mb-4">
                    <label htmlFor="state" className="block text-zinc-300 font-bold mb-2">
                        State
                    </label>
                    <input
                        type="text"
                ...
                <div className="mb-4">
                    <label htmlFor="zipCode" className="block text-zinc-300 font-bold mb-2">
                        Zip Code
                    </label>
                    <input
                        type="text"
                ...
                <div className="mb-4">
                    <label htmlFor="country" className="block text-zinc-300 font-bold mb-2">
                        Country
                    </label>
                    <input
                        type="text"
    ...
    return (
        <div className="w-full max-w-3xl">
            ...
            {isDirty && (<div className="mb-3 rounded border border-amber-800 bg-amber-950/40 px-3 py-2 text-sm text-amber-200">You have unsaved changes</div>)}
