...
const ComponentNotificationItem = ({
        ...
        return (
            <Fragment>
                <div className="mb-1">
                    ...
                    <div className="text-sm text-zinc-400 flex flex-wrap gap-2 items-center">
                        <span
                ...
                {notificationObj.text && notificationObj.text.length > 0 && (
                    <p className="mb-2 whitespace-pre-wrap border border-zinc-700 rounded-sm p-1 text-sm">{notificationObj.text}</p>
                )}
                {notificationObj.html && notificationObj.html.length > 0 && (
                    <p className="mb-2 border border-zinc-700 rounded-sm p-1 text-sm">
    ...
    return (
        <div
            className="my-2 py-2 bg-zinc-900 rounded-sm px-2"
