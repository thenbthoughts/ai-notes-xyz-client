...
const ComponentRightWrapper = ({
    ...
    return (
        <div
            className="min-h-0 overflow-y-auto bg-zinc-800/80 px-2 py-1.5 sm:px-3 sm:py-2"
            style={{ height: 'calc(100vh - 60px)' }}
        >
            <div className="mb-2 flex flex-wrap items-center justify-between gap-2 rounded-xl border border-zinc-700/80 bg-zinc-900 px-2.5 py-1.5 shadow-sm sm:mb-2.5 sm:px-3 sm:py-2">
