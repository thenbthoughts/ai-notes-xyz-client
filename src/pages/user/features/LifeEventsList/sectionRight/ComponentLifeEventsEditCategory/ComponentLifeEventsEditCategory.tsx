...
const ComponentFilterCategory = ({ value, onChange }: {
    ...
    return (
        <div>
            {loading && (
                <select
                    className="mt-1 block w-full rounded-lg border border-zinc-700/90 bg-zinc-900 p-2 text-sm text-zinc-100 shadow-sm focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 sm:p-2.5"
                    value={value}
                    onChange={onChange}
                >
