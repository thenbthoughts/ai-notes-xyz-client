...
const AiCallNew = ({
    ...
    const renderStats = () => {
        return (
            <div>
                {/* Stats */}
                <div className="bg-zinc-900/80 backdrop-blur-sm rounded p-2 mt-2 border border-zinc-700/50 shadow-sm text-zinc-100">
                    {/* Header */}
                    <div
                ...
                <div className="bg-zinc-900/80 backdrop-blur-sm rounded p-2 mt-2 border border-zinc-700/50 shadow-sm text-zinc-100">
                    ...
                    <div className="flex items-center justify-between mb-1.5">
                        <div className="flex items-center gap-1">
                            ...
                            <span className="text-xs font-medium text-zinc-100">Next message in</span>
                        </div>
                        <div className="text-base font-bold text-blue-400 bg-zinc-950 px-2 py-[2px] rounded">
                            {sendingInSeconds}s
                        </div>
                    </div>
                        ...
                        <div className="flex flex-wrap gap-0.5">
                            <button
                                className={`px-2 py-1 rounded font-medium text-xs transition-all duration-150 ${sendingInSeconds === 10
                                    ...
                                    : 'bg-zinc-800 hover:bg-zinc-800 text-zinc-100 hover:shadow-sm'
                                    }`}
                ...
                {nextMessage.trim().length > 0 && (
                    <div className="mt-6 flex items-center gap-3 px-3 py-2 rounded bg-gradient-to-r from-blue-950/60 via-zinc-950 to-zinc-900 shadow">
                        <LucideSpeech className="text-blue-400" size={24} />
                        <div className="flex-1 overflow-x-auto scrollbar-thin">
                            <span className="font-medium text-blue-300">Voice Preview:</span>
                            <span className="ml-2 text-blue-400">{nextMessage.trim()}</span>
                        </div>
                    </div>
                )}
            </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    {turn.content}
                                    {turn.createdAtUtc && (
                                        <div className={`text-xs mt-1 opacity-70 ${isUser ? 'text-blue-100' : 'text-zinc-400'
                                            }`}>
    ...
    const renderConfigureApiKeys = () => {
        return (
            <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-black">
                <div className="p-3 w-full max-w-sm rounded border border-zinc-700 bg-zinc-900/90 backdrop-blur flex flex-col items-center shadow animate-fade-in">
                    <div className="flex items-center gap-1 mb-2">
                        <span className="inline-block w-2 h-2 rounded bg-blue-500 animate-pulse" />
                        <h2 className="text-base font-bold text-zinc-100">AI Call Setup Needed</h2>
                    </div>
                    ...
                    <div className="space-y-2 w-full mb-3">
                        ...
                        {!areApiKeysValidResult.stt && (
                            <div className="flex items-center justify-between bg-zinc-950 border-l-2 border-blue-300 px-2 py-1 rounded-sm">
                                <div className="flex items-center gap-1">
                        ...
                        {!areApiKeysValidResult.llm && (
                            <div className="flex items-center justify-between bg-zinc-950 border-l-2 border-indigo-300 px-2 py-1 rounded-sm">
                                <div className="flex items-center gap-1">
                                    <span className="w-2 h-2 rounded border bg-red-300 border-red-300 animate-pulse"></span>
                                    <span className="font-medium text-zinc-100 text-xs">
                                        LLM
                        ...
                        {!areApiKeysValidResult.tts && (
                            <div className="flex items-center justify-between bg-zinc-950 border-l-2 border-purple-300 px-2 py-1 rounded-sm">
                                <div className="flex items-center gap-1">
                                    <span className="w-2 h-2 rounded border bg-red-300 border-red-300 animate-pulse"></span>
                                    <span className="font-medium text-zinc-100 text-xs">
                                        TTS
                        ...
                        {(areApiKeysValidResult.stt || areApiKeysValidResult.llm || areApiKeysValidResult.tts) ? null : (
                            <div className="text-[11px] text-zinc-400 text-center py-1">No valid API keys found.</div>
                        )}
                    </div>
                    ...
                    <div className="flex gap-2 justify-center mt-1 w-full">
                        <button
                            ...
                            className="px-2 py-1 rounded bg-zinc-800 text-zinc-100 hover:bg-zinc-800 text-xs"
                        >
                            ← Back
                        </button>
                        <button
