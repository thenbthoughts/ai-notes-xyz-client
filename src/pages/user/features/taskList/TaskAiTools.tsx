        ...
        <div>
            {loading && (
                <div className="flex justify-center py-2">
                    <div className="h-4 w-4 animate-spin rounded-full border-2 border-zinc-700 border-t-indigo-600" />
                </div>
            )}
            ...
            <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-2 sm:gap-2 lg:grid-cols-3">
                {tasks.map((task, index) => (
                    <div
                        key={index}
                        className="rounded-xl border border-zinc-700/60 bg-zinc-900 p-2 text-left shadow-sm transition-shadow hover:shadow-md sm:p-2.5"
                    >
                        <h3 className="text-sm font-semibold leading-tight text-zinc-100">{task.taskTitle}</h3>
                        <p className="mt-0.5 line-clamp-2 text-[11px] leading-snug text-zinc-400">{task.taskDescription}</p>
                        ...
                        <button
                            ...
                            className="mt-1.5 inline-flex w-full items-center justify-center gap-1 rounded-lg bg-emerald-600 py-1.5 text-[11px] font-medium text-white shadow-sm transition-colors hover:bg-emerald-9500"
                        >
            ...
            <div className="rounded-xl border border-zinc-700/60 bg-zinc-900 p-2.5 shadow-sm sm:p-3">
                ...
                <div className="mb-2 flex flex-wrap gap-1.5 sm:gap-2">
                    <button
                        ...
                        className="inline-flex items-center gap-1 rounded-lg bg-indigo-600 px-2.5 py-1.5 text-xs font-medium text-white shadow-sm transition-colors hover:bg-indigo-9500"
                    >
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-1 rounded-lg border border-zinc-700/80 bg-zinc-900 px-2.5 py-1.5 text-xs font-medium text-zinc-200 shadow-sm transition-colors hover:bg-zinc-800"
                    >
