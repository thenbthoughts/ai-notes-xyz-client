        ...
        <div>
            <div className="mb-1 flex items-center justify-between gap-1.5">
                <h2 className="flex items-center gap-1 text-xs font-medium text-zinc-700">
                    <span className="rounded-md bg-zinc-100 p-0.5">
                        <Kanban className="h-3 w-3 text-zinc-600" strokeWidth={2} aria-hidden />
                    </span>
                    Status lists
                </h2>
                <button
                    ...
                    className="rounded-lg border border-zinc-200/80 bg-white p-1 text-zinc-600 shadow-sm transition-colors hover:bg-zinc-50"
                    title="Refresh lists"
                >
            ...
            <div className="flex gap-1">
                <input
                    ...
                    className="min-w-0 flex-1 rounded-lg border border-zinc-200/90 bg-zinc-50/80 py-1.5 px-2 text-xs text-zinc-900 shadow-sm focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/15"
                    value={newListName}
