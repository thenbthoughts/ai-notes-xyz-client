...
const taskEditSelectBase =
    'rounded-lg border border-zinc-700/90 bg-zinc-800 py-1.5 pl-2 pr-1.5 text-xs leading-tight text-zinc-100 shadow-sm focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 sm:py-2 sm:pl-2.5 sm:pr-2';
...
export const taskEditInputClass =
    'w-full rounded-lg border border-zinc-700/90 bg-zinc-800 py-1.5 px-2 text-xs text-zinc-100 shadow-sm transition placeholder:text-zinc-400 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 sm:py-2 sm:px-2.5';