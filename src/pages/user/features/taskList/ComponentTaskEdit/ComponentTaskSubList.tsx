...
const ComponentSubTaskItem = ({
    ...
    return (
        <div>
            <div
                className="w-full rounded-xl border border-zinc-700/70 bg-zinc-900 p-1 shadow-sm"
            >
                <div
                    className='px-1.5'
                >
                    {showEditTitle ? (
                        <textarea
                            ...
                            className="mt-0.5 w-full rounded-md border border-zinc-700/80 bg-zinc-900 p-1.5 text-xs text-zinc-100 transition placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/15"
                            rows={2}
                        />
                    ) : (
                        <span className="text-xs leading-snug text-zinc-200">{formData.title}</span>
                    )}
                </div>
                ...
                {showMoreOptions && (
                    <div className="px-1.5 pb-0.5">
                        <button
                            ...
                            className="rounded-md px-1.5 py-0.5 text-[11px] font-medium text-indigo-700 transition-colors hover:bg-indigo-950 hover:text-indigo-200"
                        >
                            Create Todo Card
                        </button>
                    </div>
    ...
    return (
        <div className="mt-1">
            ...
            <div className="space-y-1">
                ...
                <div className="mt-1.5 gap-1">
                    <textarea
                        ...
                        className="w-full rounded-md border border-zinc-700/80 bg-zinc-900 p-1.5 text-xs text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/15"
                        rows={2}
                    />
                    <div className='mt-1 flex items-center gap-1'>
                        <button
                            ...
                            className="flex items-center rounded-md border border-indigo-700/80 bg-zinc-900 px-2 py-1 text-indigo-700 shadow-sm transition hover:bg-indigo-950"
                        >
                            <Plus size={14} />
                        </button>
            ...
            {newTaskSubtasks.length > 0 && (
                <div className="mt-1.5 rounded-xl border border-zinc-700/80 bg-zinc-950/60 p-1.5">
                        ...
                        {newTaskSubtasks.map((subtask, index) => (
                            <div
                                ...
                                className={`
                                    ...
                                    ${index === newTaskSubtasks.length - 1 ? '' : 'border-b border-zinc-800'} 
                                    pb-0.5
                                `}
                            >
                                ...
                                <button
                                    ...
                                    className="shrink-0 rounded-md bg-indigo-600 px-1.5 py-0.5 text-[11px] font-semibold text-white shadow-sm transition hover:bg-indigo-9500"
                                >
                                    Add
                                </button>
                            </div>
