...
const iconTileClass =
    'inline-flex h-14 w-14 shrink-0 items-center justify-center rounded-md border border-zinc-700 bg-zinc-950 text-zinc-400 hover:bg-zinc-800';
        ...
        return (
            ...
            >
                <img
                    src={mediaUrl}
                    alt={title}
                    className="max-h-20 max-w-[7.5rem] rounded-md border border-zinc-700 object-cover"
                    loading="lazy"
                />
            </a>
        );
