            ...
            <div className="relative flex h-full w-full flex-col">
                <div className="flex shrink-0 items-center justify-between gap-3 px-3 py-2 text-white">
                    ...
                    <div className="relative flex shrink-0 items-center gap-1" ref={menuRef}>
                        ...
                        {menuOpen && (
                            <div className="absolute right-0 top-9 z-20 min-w-[160px] overflow-hidden rounded-lg border border-zinc-700 bg-zinc-900 py-1 shadow-xl">
                                <button
                                    type="button"
                                    onClick={handleDownload}
                                    className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs text-zinc-200 hover:bg-zinc-800"
                                >
                                    <LucideDownload size={14} className="text-zinc-400" />
                                    Download
                                </button>
                                <button
                                    type="button"
                                    ...
                                    className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs text-zinc-200 hover:bg-zinc-800"
                                >
                                    <LucideExternalLink size={14} className="text-zinc-400" />
                                ...
                                <button
                                    ...
                                    disabled={deleting}
                                    className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs text-red-400 hover:bg-zinc-800 disabled:opacity-50"
                                >
                ...
                <div className="relative flex min-h-0 flex-1 items-center justify-center px-12 py-3">
                    ...
                    {fileType !== 'image' && fileType !== 'video' && fileType !== 'audio' && (
                        <div className="flex w-full max-w-sm flex-col items-center gap-4 rounded-xl bg-zinc-900 px-6 py-8 text-center shadow-lg">
                            ...
                            <button
                                type="button"
                                onClick={handleDownload}
                                className="inline-flex items-center gap-1.5 rounded-md bg-zinc-800 px-3 py-1.5 text-xs font-medium text-zinc-100 hover:bg-zinc-700"
                            >
