...
const iconWrap =
    'flex h-full w-full items-center justify-center bg-zinc-800 text-zinc-400';
...
export const TimelineFileVisual = ({
    ...
    if (fileType === 'video') {
        return (
            <div className={compact ? 'flex h-12 w-12 items-center justify-center rounded bg-zinc-800' : iconWrap}>
