...
const ComponentTimelineFiles = () => {
    ...
    const renderPagination = () => {
        ...
        return (
            <div className="mt-4 flex flex-col items-center gap-2 border-t border-zinc-800 pt-3">
                ...
                <ReactPaginate
                    ...
                    pageLinkClassName="w-full h-full flex items-center justify-center px-2 text-xs rounded-md text-zinc-400 hover:bg-zinc-800 cursor-pointer"
                    ...
                    previousLinkClassName="h-full flex items-center justify-center px-2.5 text-xs rounded-md text-zinc-400 hover:bg-zinc-800 cursor-pointer"
                    nextClassName="h-7 flex items-center justify-center"
                    nextLinkClassName="h-full flex items-center justify-center px-2.5 text-xs rounded-md text-zinc-400 hover:bg-zinc-800 cursor-pointer"
    ...
    return (
        <div className="p-2">
            <div className="mb-1 flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1 rounded-md border border-zinc-700 bg-zinc-950 p-0.5">
                    <button
                        type="button"
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                    {list.map((item) => (
                        <button
                            ...
                            className="group overflow-hidden rounded-lg border border-zinc-700 bg-zinc-900 text-left transition hover:border-zinc-600 hover:shadow-sm"
                        >
            ...
            {!loading && list.length > 0 && viewMode === 'list' && (
                <div className="divide-y divide-zinc-800 overflow-hidden rounded-lg border border-zinc-700 bg-zinc-900">
                    {list.map((item) => (
                        <button
                            key={item._id}
                            type="button"
                            onClick={() => openPreview(item)}
                            className="flex w-full items-center gap-3 px-2.5 py-2 text-left transition hover:bg-zinc-800"
                        >
