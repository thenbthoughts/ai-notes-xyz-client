...
const btnPrimary =
    'inline-flex items-center gap-0.5 rounded-lg border border-indigo-500/20 bg-indigo-600 px-2 py-1 text-[10px] font-medium uppercase tracking-wide leading-tight text-white shadow-sm transition-colors hover:bg-indigo-9500';
...
const ComponentNotesLeft = () => {
    ...
    return (
        <div className="space-y-2 px-2 py-2 sm:space-y-3 sm:px-3 sm:py-3">
            ...
            <header className="border-b border-zinc-800 pb-2 sm:pb-3">
                <div className="flex items-center gap-2">
                    <span className="h-7 w-0.5 shrink-0 rounded-full bg-indigo-9500" aria-hidden />
                    <div className="min-w-0">
                        <h1 className="text-xs font-semibold uppercase tracking-wider text-zinc-200">Notes</h1>
            ...
            <section
                className="rounded-xl border border-zinc-700/60 bg-zinc-900 p-2 shadow-sm sm:p-3"
            ...
            >
                <div className="mb-1.5 flex items-center justify-between gap-2 sm:mb-2">
                    ...
                    {(searchTerm.trim() !== '' || isStar !== '') && (
                        <span className="font-mono text-[9px] text-amber-400" title="Filters change the main note list">
                            active
                        </span>
                    )}
                </div>
                ...
                <div className="space-y-1.5 sm:space-y-2">
                    <div>
                        ...
                        <div className="relative flex items-center">
                            ...
                            <DebounceInput
                                ...
                                className="w-full rounded-lg border border-zinc-700/90 bg-zinc-950/80 py-2 pl-8 pr-7 text-[11px] text-zinc-100 placeholder:text-zinc-400 transition-shadow focus:border-indigo-400 focus:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/15"
                            ...
                            {searchTerm.length > 0 && (
                                <button
                                    type="button"
                                    className="absolute right-1 flex h-6 w-6 items-center justify-center rounded-md text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-zinc-300"
                    ...
                    <div>
                        ...
                        <div
                            className="flex w-full rounded-lg border border-zinc-700/80 bg-zinc-800/80 p-0.5"
                            role="group"
...
const ComponentNotesLeftRender = () => {
    return (
        <div className="h-full min-h-0 border-r border-zinc-800 bg-zinc-950/90">
...
const ComponentNotesLeftModelRender = () => {
    return (
        ...
        >
            <div className="border-y border-r border-zinc-800 border-l-0 bg-zinc-950/95 shadow-[4px_0_24px_-8px_rgba(0,0,0,0.08)] backdrop-blur-sm">
