        ...
        <div
            className={
                pageName.actionType === 'edit'
                    ? 'notes-right-scroll h-full min-h-0 min-w-0 max-w-full overflow-y-auto overflow-x-hidden bg-zinc-950 px-2 sm:px-0'
                    : 'notes-right-scroll h-full min-h-0 min-w-0 max-w-full overflow-y-auto bg-zinc-950 px-2 py-1.5 sm:py-2'
            }
        >
            {pageName.actionType === 'list' && (
                <div className="mb-1.5 flex flex-wrap items-center justify-between gap-1.5 rounded-xl border border-zinc-700/60 bg-zinc-900 px-2.5 py-1.5 text-xs text-zinc-400 shadow-sm sm:mb-2 sm:gap-2 sm:px-3 sm:py-2">
                    <span className="font-medium text-zinc-300">Notes</span>
                    <button
                        type="button"
                        className="inline-flex items-center gap-1 rounded-lg border border-zinc-700/80 bg-zinc-950 px-2 py-1 text-[11px] font-medium text-zinc-300 transition-colors hover:bg-zinc-800"
                        onClick={async () => {
