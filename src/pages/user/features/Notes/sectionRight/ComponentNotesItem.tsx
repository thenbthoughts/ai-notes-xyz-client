        ...
        return (
            <Fragment>
                ...
                {isExpandedDescription && (
                    <p className="mb-2 whitespace-pre-wrap border border-gray-200 rounded-sm p-1">{noteObj.description}</p>
                )}

                {/* ai summary */}
                {isExpandedAiSummary && (
                    <p className="mb-2 whitespace-pre-wrap border border-gray-200 rounded-sm p-1">{noteObj.aiSummary}</p>
                )}
            </Fragment>
        )
    }
