...
const ComponentRightWrapper = ({
    ...
    return (
        ...
        >
            <div className="mb-2 flex flex-wrap items-center justify-between gap-2 rounded-xl border border-zinc-700/80 bg-zinc-900 px-2.5 py-1.5 shadow-sm sm:mb-3 sm:px-3 sm:py-2">
