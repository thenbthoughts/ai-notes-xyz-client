...
const ComponentComputedReminderDates = ({
    ...
    return (
        <div className="mt-3">
            <div className="mb-1.5 text-sm font-medium text-zinc-200 sm:mb-2">Computed reminder dates</div>
            <div className="max-h-[160px] overflow-y-auto rounded-xl border border-zinc-700/80 bg-zinc-900 p-2 text-xs sm:p-2.5 [scrollbar-width:thin]">
