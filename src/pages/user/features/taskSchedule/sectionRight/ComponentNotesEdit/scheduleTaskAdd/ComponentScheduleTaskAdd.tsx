...
const ComponentScheduleTaskAdd = ({
    ...
    return (
        <div className="rounded-xl border border-zinc-700/80 bg-zinc-950/50 p-3 sm:p-4">
            ...
            <h2 className="my-2 text-lg font-semibold tracking-tight text-zinc-100 sm:my-3 sm:text-xl">Task Add</h2>
            ...
            <div className="py-1.5 sm:py-2">
                <label className="block text-sm font-medium text-zinc-200">Task Date Prefix</label>
                <div className="space-y-2">
                    <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="noDatePrefix" className="ml-2 text-sm text-zinc-400">
                            No date prefix
                        </label>
                    </div>
                    <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="taskDatePrefix" className="ml-2 text-sm text-zinc-400">
                    ...
                    <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="taskDateTimePrefix" className="ml-2 text-sm text-zinc-400">
            ...
            <div className="py-1.5 sm:py-2">
                <label className="block text-sm font-medium text-zinc-200">Task Workspace *</label>
            ...
            {/* field -> task status */}
            <div className="py-1.5 sm:py-2">
                <label className="block text-sm font-medium text-zinc-200">Task Status *</label>
            ...
            {/* field -> subtask list */}
            <div className="py-1.5 sm:py-2">
                <label className="block text-sm font-medium text-zinc-200">Subtask</label>
                <div className="space-y-2">
                    {formDataTaskAdd.subtaskArr.map((subtask, index) => (
                        <div key={index} className="flex items-center gap-1 rounded">
                            <textarea
                                ...
                                className="w-full flex-1 rounded-lg border border-zinc-700/90 bg-zinc-900 p-1.5 text-sm text-zinc-100 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/15"
                    ...
                    <button
                        ...
                        className="rounded-lg bg-indigo-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-indigo-9500"
                    >
                        Add Subtask
                    </button>
                </div>
            ...
            <div className="py-1.5 sm:py-2">
                <label className="block text-sm font-medium text-zinc-200">Task Deadline Enabled</label>
                <input
                    type="checkbox"
                ...
                />
                <label htmlFor="taskDeadlineEnabled" className="ml-2 text-sm text-zinc-400">
            ...
            {formDataTaskAdd.taskDeadlineEnabled && (
                <div className="py-1.5 sm:py-2">
                    <label className="block text-sm font-medium text-zinc-200">Deadline (number of days)</label>
                    <div className="flex flex-wrap items-center gap-2">
                        <input
                            ...
                            className="mt-1 block w-full min-w-[6rem] rounded-lg border border-zinc-700/90 bg-zinc-900 p-2 text-sm shadow-sm focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 sm:max-w-xs"
                        />
                        <label htmlFor="taskDeadlineDays" className="ml-0 text-sm text-zinc-400 sm:ml-2">days</label>
                    </div>
                </div>
            )}
            ...
            <div className="py-1.5 sm:py-2">
                <label className="block text-sm font-medium text-zinc-200">Task AI Summary and Subtask</label>
                <input
                    type="checkbox"
                    id="taskAiSummary"
                ...
                />
                <label htmlFor="taskAiSummary" className="ml-2 text-sm text-zinc-400">
            ...
            {formDataTaskAdd.taskAiSummary && (
                <div className="py-1.5 sm:py-2">
                    <label className="block text-sm font-medium text-zinc-200">Task AI Context</label>
                    <textarea
