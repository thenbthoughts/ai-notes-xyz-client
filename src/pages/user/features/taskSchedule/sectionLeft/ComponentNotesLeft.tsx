...
const ComponentNotesLeft = () => {
    ...
    const seg = (on: boolean) =>
        on
            ...
            : 'border-zinc-700 bg-zinc-900 text-zinc-700 hover:border-zinc-500';

    return (
        <div className="px-2 py-3 text-zinc-100">
            <div className="mb-3 flex items-baseline justify-between gap-2">
                <h2 className="text-sm font-semibold tracking-tight text-zinc-100">Schedule</h2>
            ...
            <div className="mb-3">
                <label className="mb-1 block text-[11px] font-medium text-zinc-400">Task type</label>
                <select
                    value={taskType}
                    onChange={(e) => setTaskType(e.target.value as TaskScheduleTaskTypeFilter)}
                    className="w-full rounded-sm border border-zinc-700 bg-zinc-900 px-2 py-1.5 text-xs text-zinc-100 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                >
            ...
            <div className="mb-2 rounded-sm border border-zinc-700 bg-zinc-950/80 px-2 py-2">
                <div className="mb-1.5 text-[11px] font-medium text-zinc-400">Status</div>
            ...
            <div className="mb-3 rounded-sm border border-zinc-700 bg-zinc-950/80 px-2 py-2">
                <div className="mb-1.5 text-[11px] font-medium text-zinc-400">Email</div>
                <div className="flex flex-wrap gap-1">
                    {(
                        [
                            ['All', '' as const],
