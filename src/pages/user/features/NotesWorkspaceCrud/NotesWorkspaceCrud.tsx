            ...
            <div className="min-h-screen bg-zinc-950 p-3 sm:p-4 md:p-6">
                <div className="max-w-7xl mx-auto">
                    <div className="animate-pulse">
                        <div className="h-6 sm:h-8 bg-zinc-800 rounded-sm w-1/2 sm:w-1/3 mb-4"></div>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-2">
                                        ...
                                        <div className="flex gap-2 sm:gap-1">
                                            <button
                                                ...
                                                className="flex-1 sm:flex-none p-2 text-blue-600 hover:bg-zinc-800 rounded-sm transition-colors"
                                                title="Edit"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="flex-1 sm:flex-none p-2 text-red-600 hover:bg-zinc-800 rounded-sm transition-colors"
                                                title="Delete"
                                            >
