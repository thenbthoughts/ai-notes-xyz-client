            ...
            <div className="bg-zinc-900 rounded-sm p-6 w-full max-w-md mx-4">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <button
                        onClick={handleClose}
                        disabled={loading}
                        className="p-1 text-zinc-400 hover:text-zinc-300 transition-colors disabled:opacity-50"
                    >
                        <LucideX size={20} />
                    </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 border border-zinc-700 bg-zinc-900 text-zinc-100 rounded-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
