...
const DriveCreateFileModal = ({
    ...
    return (
        ...
        >
            <div
                className="flex max-h-[90vh] w-full max-w-lg flex-col rounded-2xl border border-zinc-700 bg-zinc-900 shadow-xl"
                onClick={(e) => e.stopPropagation()}
            >
                <div className="flex items-center justify-between border-b border-zinc-800 px-5 py-4">
                    <div className="flex items-center gap-2">
                        <LucideFilePlus size={18} className="text-sky-600" />
                        <h2 className="text-lg font-semibold text-zinc-100">Create file</h2>
                    </div>
                    <button
                        type="button"
                        disabled={creating}
                ...
                <form onSubmit={handleSubmit} className="flex min-h-0 flex-1 flex-col">
                    <div className="space-y-4 overflow-y-auto px-5 py-4">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-sm font-medium text-zinc-300">File name</label>
                            <input
                                type="text"
                                value={fileName}
                                disabled={creating}
                            ...
                            {nameError ? (
                                ...
                                <p className="text-xs text-zinc-500">
                                    Will be saved as{' '}
                                    <span className="font-mono text-zinc-400">{previewName}</span>
                                </p>
                            )}
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                className="w-full resize-y rounded-lg border border-zinc-700 px-3 py-2 font-mono text-sm outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-100"
                            />
                        </div>
