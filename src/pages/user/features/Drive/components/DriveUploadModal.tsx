...
const DriveUploadModal = ({
    ...
    return (
        ...
        >
            <div
                className="w-full max-w-lg rounded-2xl border border-zinc-700 bg-zinc-900 shadow-xl"
                onClick={(e) => e.stopPropagation()}
            >
                <div className="flex items-center justify-between border-b border-zinc-800 px-5 py-4">
                    <div className="flex items-center gap-2">
                        <LucideUpload size={18} className="text-sky-600" />
                        <h2 className="text-lg font-semibold text-zinc-100">Upload file</h2>
                    </div>
                    <button
                        type="button"
                        disabled={uploading}
                ...
                <form onSubmit={handleSubmit} className="space-y-4 px-5 py-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <input
                            ...
                            className="block w-full text-sm text-zinc-400 file:mr-3 file:rounded-lg file:border-0 file:bg-sky-950 file:px-3 file:py-2 file:text-sm file:font-medium file:text-sky-300 hover:file:bg-sky-900"
                        />
                    </div>

                    <div className="space-y-1.5">
                        <label className="text-sm font-medium text-zinc-300">
                            File name <span className="font-normal text-zinc-500">(optional)</span>
                        </label>
                        <input
                            type="text"
                            value={customName}
                            ...
                            className="w-full rounded-lg border border-zinc-700 px-3 py-2 text-sm outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-100"
                        />
                    </div>
