...
const btnIdle =
    'inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-zinc-700/90 bg-zinc-900 text-zinc-400 shadow-sm transition-colors hover:border-zinc-600 hover:bg-zinc-800 hover:text-zinc-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/40';

const btnRecording =
    'inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-rose-200/90 bg-rose-950/40 text-rose-700 shadow-sm transition-colors hover:border-rose-300 hover:bg-rose-900/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-400/40';
