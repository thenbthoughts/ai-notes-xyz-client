    ...
    return (
        <Fragment>
            <button
                ...
                className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-zinc-700/90 bg-zinc-900 text-zinc-400 shadow-sm transition-colors hover:border-zinc-600 hover:bg-zinc-800 hover:text-zinc-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/40"
                onClick={() => {
            ...
            <input
                ...
                className="mb-4 p-3 border border-zinc-700 rounded-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                multiple
                hidden
                ref={fileInputRef}
                accept="image/*"
