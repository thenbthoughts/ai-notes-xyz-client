...
const ChatLlmListWrapper = () => {
    ...
    return (
        <div className="flex min-h-0 w-full bg-gradient-to-br from-zinc-800 via-zinc-950 to-zinc-800">
            {renderSeo()}
                    ...
                    <div className="flex flex-row">
                        ...
                        >
                            <div className="mx-auto w-full max-w-none">
                                <div className="h-[calc(100vh-60px)] overflow-hidden rounded-none border-zinc-700/60 bg-zinc-900/40 backdrop-blur-[2px] lg:rounded-l-2xl lg:border-l lg:border-t lg:border-b">
            ...
            {(hideRightSidebar.isOpen === true || screenWidth === screenList.lg) && (
                <div className="flex w-[52px] shrink-0 flex-row items-stretch border-l border-zinc-700/70 bg-gradient-to-b from-zinc-950/90 via-zinc-900 to-zinc-800/95 py-2 shadow-[inset_1px_0_0_rgba(39,39,42,0.85),2px_0_32px_-16px_rgba(15,23,42,0.07)] backdrop-blur-xl">
                    <div
                        aria-hidden
