...
const SelectModel: React.FC<SelectModelProps> = ({
    ...
    const renderLlmTab = () => (
        <>
            <div className="mb-2">
                <h3 className="mb-1.5 text-xs font-medium text-zinc-300">Provider</h3>
                        ...
                        <button
                            ...
                            className={`flex-1 rounded-xl border px-2 py-2 text-xs font-medium transition-all sm:min-w-[5.5rem] ${
                                aiModelProvider === provider.value
                                    ...
                                    : 'border-zinc-700/90 bg-zinc-950/80 text-zinc-200 hover:border-zinc-600 hover:bg-zinc-900'
                            }`}
            ...
            <div className="mt-2">
                <Link to="/user/setting" className="text-sm text-zinc-400 hover:text-zinc-300 inline-block mr-5">
    ...
    return (
        <div className="mb-5 rounded-2xl border border-zinc-700/80 bg-zinc-900/90 p-4 shadow-lg shadow-zinc-900/[0.04] ring-1 ring-zinc-700/[0.02] backdrop-blur-sm sm:p-5">
            ...
            <div
                className="mb-2 flex rounded-lg border border-zinc-700/90 bg-zinc-950/80 p-0.5"
                role="tablist"
                ...
                {MODEL_TABS.map((tab) => (
                    <button
                        ...
                        className={`flex-1 rounded-md px-2 py-1 text-[11px] font-medium transition-all ${
                            activeTab === tab.id
                                ? 'bg-zinc-900 text-teal-300 shadow-sm ring-1 ring-zinc-700/80'
