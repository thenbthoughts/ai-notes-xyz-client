        ...
        <Fragment>
            ...
            {expanded && sttModelProvider === 'localai' && (
                <div className="mb-1 lg:mb-2">
                    <h3 className="text-sm font-medium text-zinc-300 mb-1 lg:mb-2">STT Model</h3>
                    {isLoadingLocalai ? (
                        <div className="text-sm text-zinc-400">Loading models...</div>
                    ) : localaiModels.length === 0 ? (
                        <div className="text-sm text-zinc-400">No STT models found. Add models in LocalAI Settings.</div>
                    ) : (
