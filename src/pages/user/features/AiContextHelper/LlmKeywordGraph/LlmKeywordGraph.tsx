...
const KnowledgeGraph: React.FC<KnowledgeGraphProps> = ({ data, onNodeClick }) => {
    ...
    const graphData = useMemo(() => {
        ...
        data.forEach(item => {
            ...
            // 3. Keyword Node
            addNode(itemId, item.keyword, 'keyword', '#312e81', 8, item);
    ...
    useEffect(() => {
        ...
        node.append("text")
            ...
            .style("text-shadow", "0 1px 0 #18181b, 1px 0 0 #18181b, 0 -1px 0 #18181b, -1px 0 0 #18181b");
    ...
    return (
        <div className='py-4'>
            <div className='container mx-auto px-2'>
                ...
                <div className="bg-zinc-950 rounded-xl overflow-hidden border border-zinc-700">
                    <div className="flex justify-between items-center p-4">
                        <div className="bg-zinc-900 rounded-lg p-3 shadow-sm border border-zinc-700 text-xs">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="w-3 h-3 rounded-full bg-indigo-900 border border-zinc-700"></span>
                                    <span className="text-zinc-400 font-medium">Keyword</span>
                                </div>
                            </div>
                        </div>
                        <div className="flex gap-2 bg-zinc-900 rounded-lg p-1 shadow-sm border border-zinc-700">
                            <button onClick={handleZoomIn} className="p-2 text-zinc-400 hover:text-indigo-600 hover:bg-indigo-950 rounded transition" title="Zoom In">
                                <ZoomIn size={20} />
                            </button>
                            <button onClick={handleReset} className="p-2 text-zinc-400 hover:text-indigo-600 hover:bg-indigo-950 rounded transition" title="Reset View">
                                <RefreshCw size={20} />
                            </button>
                            <button onClick={handleZoomOut} className="p-2 text-zinc-400 hover:text-indigo-600 hover:bg-indigo-950 rounded transition" title="Zoom Out">
                                <ZoomOut size={20} />
                            </button>
                        </div>
                    </div>
                    ...
                    <div
                        className='container mx-auto px-2 bg-zinc-900'
                    >
