    ...
    const pillClass = (active: boolean) =>
        `rounded-sm border px-2 py-0.5 text-[11px] font-medium transition-colors ${
            active
                ...
                : 'border-zinc-700 bg-zinc-900 text-zinc-700 hover:border-zinc-600'
        }`;

    return (
        <div className="px-2 py-3 text-zinc-100">
            <div className="mb-3 flex items-baseline justify-between gap-2">
                <h2 className="text-sm font-semibold tracking-tight text-zinc-100">Info Vault</h2>
            ...
            <div className="mb-2 flex flex-col gap-1.5 sm:flex-row">
                ...
                <button
                    type="button"
                    className="rounded-sm border border-zinc-700 bg-zinc-900 px-2 py-1.5 text-xs font-medium text-zinc-700 shadow-sm hover:bg-zinc-800"
            ...
            <div className="relative mb-3">
                ...
                <DebounceInput
                    ...
                    type="text"
                    placeholder="Search…"
                    className="w-full rounded-sm border border-zinc-700 bg-zinc-900 py-1.5 pl-7 pr-2 text-xs text-zinc-100 placeholder:text-zinc-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
            ...
            <div className="mb-2 space-y-2">
                <div className="rounded-sm border border-zinc-700 bg-zinc-950/80 px-2 py-2">
                    <div className="mb-1.5 text-[11px] font-medium text-zinc-400">Type</div>
                ...
                <div className="rounded-sm border border-zinc-700 bg-zinc-950/80 px-2 py-2">
                    <div className="mb-1.5 text-[11px] font-medium text-zinc-400">Relationship</div>
                    <div className="flex flex-wrap gap-1">
                ...
                <div className="rounded-sm border border-zinc-700 bg-zinc-950/80 px-2 py-2">
                    <div className="mb-1.5 text-[11px] font-medium text-zinc-400">Archived</div>
                    <div className="flex flex-wrap gap-1">
                        {[
                            { label: 'All', value: '' as const },
                ...
                <div className="rounded-sm border border-zinc-700 bg-zinc-950/80 px-2 py-2">
                    <div className="mb-1.5 text-[11px] font-medium text-zinc-400">Starred</div>
                    <div className="flex flex-wrap gap-1">
                        {[
                            { label: 'All', value: '' as const },
                            { label: 'Yes', value: 'true' as const },
...
const ComponentInfoVaultLeftWrapperRender = () => {
    return (
        <div className="border-r border-zinc-700 bg-zinc-950">
            <div className="h-[calc(100vh-60px)] overflow-y-auto border-zinc-700 bg-zinc-900">
...
const ComponentInfoVaultLeftWrapperModelRender = () => {
    return (
        <div className="fixed left-0 top-[60px] z-[1001] w-[min(300px,calc(100%-50px))] border-r border-zinc-700 shadow-lg">
            <div className="h-[calc(100vh-60px)] overflow-y-auto bg-zinc-900">
                <ComponentInfoVaultLeftWrapper />
            </div>
        </div>
    );
