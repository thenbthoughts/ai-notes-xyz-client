...
const ComponentRightWrapper = ({
    ...
    return (
        <div
            className="min-h-0 overflow-y-auto bg-zinc-950 px-2 py-2 md:px-3"
            style={{ height: 'calc(100vh - 60px)' }}
        >
            <div className="mb-3 flex flex-wrap items-center justify-between gap-2 rounded-sm border border-zinc-700 bg-zinc-900 px-3 py-2 shadow-sm">
