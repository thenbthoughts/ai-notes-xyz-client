        ...
        <div className="border border-zinc-700 bg-zinc-900 p-3 rounded-sm hover:shadow-sm transition-shadow">
            <div className="flex flex-col gap-2">
                <div className="grid grid-cols-1 gap-2">
                    <label className="text-xs font-medium text-zinc-200">Address</label>
                    <DebounceInput
                        element="textarea"
                        ...
                        className="w-full px-2 sm:px-3 py-2 border border-zinc-700 bg-zinc-900 text-zinc-100 rounded-sm text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400 transition-colors resize-vertical"
                        rows={3}
                    />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <div>
                        <label className="block text-xs font-medium text-zinc-200">City</label>
                        <DebounceInput
                            debounceTimeout={1000}
                            type="text"
                            placeholder="City"
                            ...
                            className="w-full px-2 sm:px-3 py-2 border border-zinc-700 bg-zinc-900 text-zinc-100 rounded-sm text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400 transition-colors"
                        />
                    </div>
                    <div>
                        <label className="block text-xs font-medium text-zinc-200">State</label>
                        <DebounceInput
                            debounceTimeout={1000}
                            type="text"
                            placeholder="State"
                    ...
                    <div>
                        <label className="block text-xs font-medium text-zinc-200">Pincode</label>
                        <DebounceInput
                            debounceTimeout={1000}
                            type="text"
                            placeholder="Pincode"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <div>
                        <label className="block text-xs font-medium text-zinc-200">Country/Region</label>
                        <DebounceInput
                            debounceTimeout={1000}
                            type="text"
                    ...
                    <div>
                        <label className="block text-xs font-medium text-zinc-200">PO Box</label>
                        <DebounceInput
                            debounceTimeout={1000}
                            type="text"
                            placeholder="PO Box"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <div>
                        <label className="block text-xs font-medium text-zinc-200">Latitude</label>
                        <DebounceInput
                            debounceTimeout={1000}
                            type="number"
                            step="any"
                    ...
                    <div>
                        <label className="block text-xs font-medium text-zinc-200">Longitude</label>
                        <DebounceInput
                            debounceTimeout={1000}
                            type="number"
                            step="any"
...
const ComponentInfoVaultAddress = ({ infoVaultId }: { infoVaultId: string }) => {
    ...
    return (
        <div className="space-y-3">
            ...
            {/* Addresses List */}
            {loading ? (
                <div className="text-zinc-400 text-sm py-4 text-center">Loading addresses...</div>
            ) : (
