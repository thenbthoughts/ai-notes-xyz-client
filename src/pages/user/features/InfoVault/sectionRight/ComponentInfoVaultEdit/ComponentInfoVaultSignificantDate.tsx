                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div>
                        <input
                            ...
                            className="w-full flex-1 px-2 sm:px-3 py-2 border border-zinc-700 bg-zinc-900 text-zinc-100 rounded-sm text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400 transition-colors"
                        />
                    </div>
                </div>
                <div className="flex flex-col sm:flex-row sm:flex-wrap gap-1">
                    <span className="text-xs text-zinc-400 mb-1 sm:mb-0">Quick suggestions:</span>
                    <div className="flex flex-wrap gap-1">
                        {['Birthday', 'Anniversary', 'Wedding', 'Graduation', 'First Met', 'Hired Date', 'Retirement'].map((suggestion) => (
                            <button
                                ...
                                className="text-xs px-2 py-1 bg-zinc-800 hover:bg-zinc-800 text-zinc-400 rounded-sm transition-colors"
                            >
                                {suggestion}
                            </button>
                        ))}
...
const ComponentInfoVaultSignificantDate = ({ infoVaultId }: { infoVaultId: string }) => {
    ...
    return (
        <div className="space-y-3">
            ...
            {loading ? (
                <div className="text-zinc-400 text-sm py-4 text-center">Loading significant dates...</div>
            ) : (
