...
const ComponentInfoVaultEdit = ({
        ...
        return (
            <div className="space-y-3 text-sm">
                ...
                <div>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-zinc-200">Sub Type</label>
                        <input
                            type="text"
                            value={formData.infoVaultSubType || ''}
                            className="mt-1 block w-full border border-zinc-700 bg-zinc-900 text-zinc-100 rounded-sm shadow-sm p-2"
                ...
                {/* field -> is star */}
                <div>
                    <label className="block text-sm font-medium text-zinc-200">Is Starred</label>
                    <input
                        type="checkbox"
                ...
                {/* field -> nickname */}
                <div>
                    <label className="block text-sm font-medium text-zinc-200">Nickname</label>
                    <input
                        type="text"
                ...
                {/* field -> photo URL */}
                <div>
                    <label className="block text-sm font-medium text-zinc-200">Photo URL</label>
                    <input
                        type="url"
                ...
                <div>
                    <label className="block text-sm font-medium text-zinc-200">Custom Fields</label>
                    <ComponentInfoVaultCustomField infoVaultId={infoVaultObj._id} />
                </div>

                <div>
                    <label className="block text-sm font-medium text-zinc-200">Emails</label>
                    <ComponentInfoVaultEmail infoVaultId={infoVaultObj._id} />
                </div>

                <div>
                    <label className="block text-sm font-medium text-zinc-200">Phones</label>
                    <ComponentInfoVaultPhone infoVaultId={infoVaultObj._id} />
                </div>

                <div>
                    <label className="block text-sm font-medium text-zinc-200">Websites</label>
                    <ComponentInfoVaultWebsite infoVaultId={infoVaultObj._id} />
                </div>

                <div>
                    <label className="block text-sm font-medium text-zinc-200">Significant Dates</label>
                    <ComponentInfoVaultSignificantDate infoVaultId={infoVaultObj._id} />
                </div>

                <div>
                    <label className="block text-sm font-medium text-zinc-200">Addresses</label>
                    <ComponentInfoVaultAddress infoVaultId={infoVaultObj._id} />
                </div>

                {/* field -> tags */}
                <div>
                    <label className="block text-sm font-medium text-zinc-200 mb-3">Tags</label>
                    ...
                    <div className="flex gap-2">
                        <input
                            ...
                            className="mt-1 block w-full border border-zinc-700 bg-zinc-900 text-zinc-100 rounded-sm shadow-sm p-2 focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition"
                ...
                <div>
                    <label className="block text-sm font-medium text-zinc-200">Relationship Type</label>
                    <select
                ...
                <div>
                    <label className="block text-sm font-medium text-zinc-200">Last Contact Date</label>
                    <input
                        type="date"
                ...
                <div>
                    <label className="block text-sm font-medium text-zinc-200">Contact Frequency</label>
                    <select
                    ...
                    <div>
                        ...
                        <div className="mt-2">
                            {formData.aiTags.map((tag, index) => (
                                <div key={index} className="inline-block bg-zinc-800 rounded-sm p-1 px-2 text-sm text-zinc-400 mb-2 mr-2">
                                    {tag}
                                </div>
                            ))}
                        </div>
                ...
                {formData.aiSummary.length > 0 && (
                    <div>
                        ...
                        <div className="mt-2 bg-zinc-950 border border-zinc-700 rounded-sm p-3 text-zinc-200 text-sm whitespace-pre-line break-words">
                            {formData.aiSummary}
                        </div>
                    </div>
                )}
                ...
                {formData.aiSuggestions.length > 0 && (
                    <div>
                        <label className="block text-sm font-medium text-zinc-200">AI Suggestions</label>
                        <div className="mt-2 bg-zinc-950 border border-zinc-700 rounded-sm p-3 text-zinc-200 text-sm whitespace-pre-line break-words">
    ...
    return (
        <div className="rounded-sm border border-zinc-700 bg-zinc-900 p-3 text-zinc-100 shadow-sm md:p-4">
            {requestEdit.loading && (
                <div className="mb-3 flex justify-between border-b border-zinc-800 pb-2">
                    <span className="inline-flex items-center gap-1.5 rounded-sm border border-zinc-700 bg-zinc-950 px-2 py-1 text-xs font-medium text-zinc-400">
            ...
            {!requestEdit.loading && (
                <div className="mb-3 flex flex-wrap items-center justify-between gap-2 border-b border-zinc-800 pb-2">
                    <Link
                        to="/user/info-vault"
                        className="inline-flex items-center gap-1 rounded-sm border border-zinc-700 bg-zinc-900 px-2 py-1 text-xs font-medium text-zinc-200 hover:bg-zinc-800"
                    >
...
const ComponentInfoVaultEditWrapper = ({
    ...
    return (
        <div>
            {loading && (
                <div className="flex flex-col items-center justify-center gap-2 rounded-sm border border-zinc-700 bg-zinc-900 py-10 shadow-sm">
                    <div className="h-6 w-6 animate-spin rounded-full border-2 border-zinc-700 border-t-emerald-600" />
                    <p className="text-xs text-zinc-400">Loading…</p>
                </div>
            )}
            {!loading && list.length === 0 && (
                <div className="rounded-sm border border-zinc-700 bg-zinc-900 px-4 py-8 text-center shadow-sm">
                    <p className="text-sm font-medium text-red-700">Record does not exist.</p>
                    <button
                        type="button"
                        className="mt-3 inline-flex rounded-sm border border-zinc-700 bg-zinc-900 px-3 py-1.5 text-xs font-medium text-zinc-200 hover:bg-zinc-800"
