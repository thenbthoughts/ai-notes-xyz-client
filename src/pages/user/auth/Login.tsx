...
export default function Component() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Here you can handle successful login, e.g., redirect or set user state
    ...
    return (
        <div className="min-h-screen py-6 flex flex-col justify-center sm:py-12 bg-zinc-950">
            <div className="container p-2 m-auto">
                <div className="py-3 sm:max-w-xl md:max-w-4xl lg:max-w-5xl mx-auto">
                    <div className="px-4 py-10 bg-zinc-900 shadow-sm rounded-sm sm:p-20">
                        <div className="max-w-md mx-auto md:max-w-full grid md:grid-cols-2 gap-8">
                            <div>
                                <div className="bg-zinc-900 shadow-lg rounded-2xl">
                                    <div className="p-6">
                                        <h2 className="text-3xl font-extrabold text-center text-zinc-200">Login to AI Notes</h2>
                                        <p className="text-zinc-400 text-center">Enter your credentials to access your AI-powered notes</p>
                                    </div>
                                        ...
                                        <div className="p-6 space-y-6">
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    className="block w-full px-4 py-3 border border-zinc-700 bg-zinc-800 text-zinc-100 rounded-sm shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                                />
                                            </div>
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center mt-2">
                                                    <input
                                                        ...
                                                        className="mr-2"
                                                    />
                                                    <label htmlFor="showPassword" className="text-sm text-zinc-400 select-none">Show Password</label>
                                                </div>
                                            </div>
                                        ...
                                        <div className="p-6 flex flex-col space-y-4">
                                            ...
                                            <div className="text-center">
                                                <div className="text-center">
                                                    <Link
                                                        to="/register"
                                                        className="w-full border border-zinc-700 text-zinc-300 py-3 px-4 rounded-sm shadow-md hover:bg-zinc-800 transition duration-300 block"
                                                    >Register</Link>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="md:flex md:items-center md:justify-center hidden">
                                <div className="max-w-md">
                                    <h2 className="text-3xl font-extrabold mb-4 text-zinc-200">Welcome to AI Notes</h2>
